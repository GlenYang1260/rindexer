...
#[cfg(test)]
mod tests {
    use super::is_known_zk_evm_compatible_chain;
    use alloy_chains::Chain;

    #[test]
    fn sei_chains_are_known_non_zk() {
        assert_eq!(is_known_zk_evm_compatible_chain(Chain::from(1329u64)), Some(false));
        assert_eq!(is_known_zk_evm_compatible_chain(Chain::from(1328u64)), Some(false));
    }
}
